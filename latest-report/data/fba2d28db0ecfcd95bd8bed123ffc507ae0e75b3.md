...
```
TypeError: gettxt.getByText is not a function
```
...
> 22 |         const gettxt = page.locator('.mat-input-0').fill("นิช");
     |                                                     ^ Error: locator.fill: Test ended.
  23 |         await gettxt.getByText(" เดอะ นิช โมโน รัชวิภา อาคาร บี (ไฟเบอร์) ตึก  ").click();
  24 | 
  25 | 
  26 | 
  27 | 
