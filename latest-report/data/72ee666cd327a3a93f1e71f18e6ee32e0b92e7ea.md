...
```ts
  ...
  29 |         //await page.pause(); 
  30 |         const optionLocator = page.getByRole('button', { name: /ตรวจสอบพื้นที่ให้บริการ/i });
  31 |         // แทนที่จะรอ URL เราก็รอให้ปุ่ม "ตรวจสอบพื้นที่ให้บริการ" ปรากฏขึ้นมาแทน
> 32 |         await optionLocator.waitFor({ state: 'visible', timeout: 30000 });
     |                             ^ Error: locator.waitFor: Test timeout of 40000ms exceeded.
  33 |         await optionLocator.click({ force: true });
  34 | 
