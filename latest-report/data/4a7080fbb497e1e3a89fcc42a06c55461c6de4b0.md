...
```
Error: locator.inputValue: Test timeout of 40000ms exceeded.
Call log:
...
> 35 |         const currentValue = await passwordField.inputValue();
     |                                                  ^ Error: locator.inputValue: Test timeout of 40000ms exceeded.
  36 |         await page.locator('input[type="text"]').fill(currentValue+'456');
  37 | 
  38 | 
  39 |         const finalValue = await page.locator('input[type="text"]').inputValue();
